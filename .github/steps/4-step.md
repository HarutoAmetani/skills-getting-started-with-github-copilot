...
1. **Copilot Chat**パネルを開き、**Plan Agent**に切り替えます。
   ...
   <img width="350" alt="image" src="https://github.com/HarutoAmetani/skills-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-dropdown.png?raw=true" />
...
1. 提案された計画を確認し、満足したら**実装を開始**をクリックして**Agentモード**に引き渡します。
   ...
   <img width="350" alt="image" src="https://github.com/HarutoAmetani/skills-getting-started-with-github-copilot/blob/main/.github/images/plan-mode-start-implementation.png?raw=true" />
